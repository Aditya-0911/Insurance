...
def calculate():
    ...
    if request.method == 'POST' and 'age' in request.form and 'bmi' in request.form:
        ...
        insurance = round(5633.51+(3715.28*int(age))+(1999.61*float(bmi))+(651.17*int(children))+(23530*int(smoking_yes)+2616.04*int(gender_male)+3017.46*int(gender_female)),2)
